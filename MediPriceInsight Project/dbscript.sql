...
--
-- Name: get_cities_for_region(text); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.get_cities_for_region(p_region text) RETURNS TABLE(city text)
    LANGUAGE plpgsql
    AS $$
BEGIN
    RETURN QUERY
...
ALTER FUNCTION public.get_cities_for_region(p_region text) OWNER TO postgres;

--
-- Name: get_codes_and_descriptions(); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.get_codes_and_descriptions() RETURNS TABLE(code text, description text)
    LANGUAGE plpgsql
    AS $$
BEGIN
    RETURN QUERY
...
ALTER FUNCTION public.get_codes_and_descriptions() OWNER TO postgres;

--
-- Name: get_distinct_cities(); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.get_distinct_cities() RETURNS TABLE(city text)
    LANGUAGE plpgsql
    AS $$
BEGIN
    RETURN QUERY
...
ALTER FUNCTION public.get_distinct_cities() OWNER TO postgres;

--
-- Name: get_distinct_payer_names(); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.get_distinct_payer_names() RETURNS TABLE(payer_name text)
    LANGUAGE plpgsql
    AS $$
BEGIN
    RETURN QUERY
...
ALTER FUNCTION public.get_distinct_payer_names() OWNER TO postgres;

--
-- Name: get_distinct_plan_names(); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.get_distinct_plan_names() RETURNS TABLE(plan_name text)
    LANGUAGE plpgsql
    AS $$
BEGIN
    RETURN QUERY
...
ALTER FUNCTION public.get_distinct_plan_names() OWNER TO postgres;

--
-- Name: get_distinct_regions(); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.get_distinct_regions() RETURNS TABLE(region text)
    LANGUAGE plpgsql
    AS $$
BEGIN
    RETURN QUERY
...
ALTER FUNCTION public.get_distinct_regions() OWNER TO postgres;

--
-- Name: get_hospital_data(text, text, text); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.get_hospital_data(p_code text, p_city text DEFAULT NULL::text, p_region text DEFAULT NULL::text) RETURNS TABLE(code text, description text, city text, region text, hospital_name text, price numeric)
    LANGUAGE plpgsql
    AS $$
BEGIN
    RETURN QUERY
...
ALTER FUNCTION public.get_hospital_data(p_code text, p_city text, p_region text) OWNER TO postgres;

--
-- Name: search_codes_and_descriptions(text); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.search_codes_and_descriptions(p_search_term text) RETURNS TABLE(code text, description text)
    LANGUAGE plpgsql
    AS $$
BEGIN
    RETURN QUERY
...
ALTER FUNCTION public.search_codes_and_descriptions(p_search_term text) OWNER TO postgres;
