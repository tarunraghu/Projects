...
columns_to_include = ['description', 'code|1', 'payer_name', 'plan_name', 'standard_charge|negotiated_dollar', 'standard_charge|max', 'standard_charge|min']
...
df_renamed = df_subset.withColumnRenamed('description', 'billing_description') \
                      ...
                      .withColumnRenamed('standard_charge|negotiated_dollar', 'gross_standard_charges') \
